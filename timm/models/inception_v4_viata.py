...
class InceptionV4ViAtA(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('g1_shape', g1.shape)
        # print('g2_shape', g2.shape)
...
def _create_inception_v4_viata(variant, pretrained=False, **kwargs):
    new_layers = kwargs.get('new_layers', 1)
    model = build_model_with_cfg(
        InceptionV4ViAtA, variant, pretrained, default_cfg=default_cfgs[variant],
...
@register_model
def inception_v4_viata(pretrained=False, **kwargs):
    return _create_inception_v4_viata('inception_v4_viata', pretrained, **kwargs)
