...
def _create_inception_v4_itr(variant, pretrained=False, **kwargs):
    new_layers = kwargs.get('new_layers', 1)
    model = build_model_with_cfg(
        InceptionV4iTR, variant, pretrained, default_cfg=default_cfgs[variant],
...
@register_model
def inception_v4_itr(pretrained=False, **kwargs):
    return _create_inception_v4_itr('inception_v4_itr', pretrained, **kwargs)