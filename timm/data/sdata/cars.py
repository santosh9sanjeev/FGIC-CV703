...
class Cars(VisionDataset):
    ...
    idx_start_from=0,
        ...
        (image_ids, targets, classes, class_to_idx) = self.find_classes(idx_start_from)
    ...
    def find_classes(self, idx_start_from):
        ...
        class_to_idx = {classes[i]: i + idx_start_from for i in range(len(classes))}
